...
def relative_handle(target, base) -> "tuple[str | None, str]":
    ...
    except OSError:  # pragma: no cover - unresolvable path yields no handle
...
def compare_workload(workload: Workload, records: "list[dict]",
    ...
    unchecked = sorted(contenders - set(eq_arms))
    ...
    if unchecked:
        entry["detail"] = (
            ...
            f"unchecked arm is not an equivalent arm, and no ratio is quotable")
