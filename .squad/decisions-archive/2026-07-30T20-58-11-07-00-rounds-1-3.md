# Decisions Archive — Rounds 1–3
# Archived: 2026-07-30T20:58:11-07:00 by Scribe
#
# Policy: archive by session round when decisions.md exceeds 40 KB.
# These rounds are complete; they are not deleted.
# decisions.md carries a pointer to this file.
#
# Supersession note: corrections are always written in later rounds.
# If an entry here was later corrected, the correction is in the live file.
# This archive contains the entry as originally recorded; treat it as historical.
#
# Contents:
#   Round 1 — 2026-07-28T17:59:54-07:00 (design session)
#   Round 2 — 2026-07-28T22:28:08-07:00 (implementation round)
#   Round 3 — 2026-07-29T09:00:39-07:00 (first-hardware round)
#   Archival check note from prior Scribe run (no entries were archived at that time)
# --
