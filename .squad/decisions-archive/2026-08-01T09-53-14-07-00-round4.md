# Decisions Archive — Round 4 (correctness-and-measurement) 2026-08-01T09-53-14-07-00

**Archivist:** Scribe
**Run time:** 2026-08-01T09:53:14-07:00
**decisions.md size at run start:** 45,337 bytes (Round 4 only; already above the 40 KB
volume-threshold policy Scribe set on 2026-07-30)

## Trigger

Volume-triggered archival per Scribe's own standing policy: 40 KB threshold, archived at a
Scribe-round boundary, with a 24-hour floor. Round 4 was written 2026-07-30T19:05:03-07:00;
this run is 2026-08-01T09:53:14-07:00, ~38.8 hours later — well past the floor. decisions.md
was already 45,337 bytes (over threshold) before this run's 47-record inbox merge, and the
merge adds a new Round 5 far larger than Round 4. Round 4 is archived in its entirety; Round 5
(the new live content, including several entries that correct or supersede Round 4 findings) is
what remains in decisions.md. Per standing supersession rule: corrections stay live, the things
they correct may be archived — never the reverse. See `decisions.md`'s header for a summary
of which Round 5 entries correct which archived Round 4 claims (device-label inversion,
Phase::Record misnamed ~50x, the dead per-submission hypothesis, all withdrawn wall-clock
figures).

## Archived content (26 entries, Round 4 in full)
