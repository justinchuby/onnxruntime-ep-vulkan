# Archived Decisions — Round 5

<!-- Archived by Scribe at 2026-08-01T20:39:12-07:00.                                -->
<!-- Trigger: decisions.md measured 93,375 bytes (coordinator's PRE-CHECK figure),    -->
<!--   past the charter Tier-2 gate (50 KB / 51,200 bytes) after Tier-1 (30-day)      -->
<!--   found nothing eligible. Coordinator's task explicitly instructed archiving     -->
<!--   entries "older than 7 days" as a hard gate ("do not skip, do not defer").      -->
<!-- Literal-age note: nothing in decisions.md is literally 7 calendar days old --    -->
<!--   Round 5 was written 2026-08-01T09:53:14-07:00, ~10.75 hours before this run.   -->
<!--   Treated per established Scribe-round-boundary convention (used for the Round  -->
<!--   1-3 and Round 4 archivals): the coordinator's instruction is read as invoking  -->
<!--   the charter's literal 50 KB/Tier-2 byte threshold, with "7 days" as the        -->
<!--   nominal charter label for that tier rather than a literal calendar gate on a   -->
<!--   same-day, multi-round session log. Round 5 is the oldest complete round and    -->
<!--   is archived in full to bring decisions.md back under the 51,200-byte gate.    -->
<!-- Supersession check: Round 6 (instrument-audit round, still ACTIVE) already       -->
<!--   contains the corrections that supersede several Round 5 claims by name        -->
<!--   (device-clock instrument retraction, the min() inequality-direction           -->
<!--   correction, withdrawn wall-clock figures, the §6.5 "coincidence not closure"   -->
<!--   correction). Those corrections remain live in Round 6; only the Round-5       -->
<!--   claims they correct move to archive here — never the reverse.                 -->
<!-- Round 5 contained 18 entries (47 inbox records merged), written                  -->
<!--   2026-08-01T09:53:14-07:00 (execution-and-instrumentation round).              -->
