...
BENCH_INSTRUMENT_FILES = [
    ...
    "pinned_bytes.py",
    "path_screen.py",
    # Arrived with issue #96. This is the criterion's clearest case yet: every public
    # function in it renders a verdict about a measurement — `classify_record` decides
